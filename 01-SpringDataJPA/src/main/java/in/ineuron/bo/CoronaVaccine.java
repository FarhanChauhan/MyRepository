...
public class CoronaVaccine implements Serializable {
	...
	public CoronaVaccine() {
		System.out.println("CoronaVaccine constructor called...");
	}
	...
	public CoronaVaccine(Integer regNo,String company, String country, String name, Integer price,Integer requiredDoseCount) {
		this.regNo = regNo;
		this.name = name;
		this.requiredDoseCount = requiredDoseCount;
		this.country = country;
