...
public class CurrencyService {
	...
	private static final String REST_END_POINT = "http://localhost:8080/api/currency/getCurremcyExchangeCostFrom/USD/to/INR";
	...
	public void invokeRestApiSync(String from, String to) {
		...
		CurrencyResponse response = webClient.get().uri(REST_END_POINT,from,to).accept(MediaType.APPLICATION_JSON).retrieve().bodyToMono(CurrencyResponse.class).block();
