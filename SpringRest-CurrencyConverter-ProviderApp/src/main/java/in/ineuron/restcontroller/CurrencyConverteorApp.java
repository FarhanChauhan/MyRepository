...
public class CurrencyConverteorApp {

	@GetMapping(value="/getCurremcyExchangeCostFrom/{from}/to/{to}")
	public ResponseEntity<CurrencyResponse> getCurreencyValue(@PathVariable String from,@PathVariable String to)
	{
