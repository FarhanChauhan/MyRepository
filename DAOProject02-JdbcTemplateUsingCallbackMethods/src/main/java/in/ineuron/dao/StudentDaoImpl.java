...
public class StudentDaoImpl implements IStudentDao {
	...
	private static final String GET_STUDENT_BY_NO = "SELECT SID,SNAME,AVG,SADDRESS FROM STUDENTS WHERE SID=?";
	private static final String GET_STUDENT_BY_NAME = "SELECT SID,SNAME,AVG,SADDRESS FROM STUDENTS WHERE SNAME IN (?,?)";
	private static final String GET_STUDENT_BY_CITY = "SELECT SID,SNAME,AVG,SADDRESS FROM STUDENTS WHERE SADDRESS IN (?,?,?)";
	...
	public List<StudentBO> fetchStudentByCitites(String city1, String city2, String city3) {
		...
		jdbcTemplate.query(GET_STUDENT_BY_CITY, (rs)->{	
			System.out.println(
